...
|----- |---|---|---|
| [![yulu](https://img.shields.io/badge/YULU-2D8CFF?style=for-the-badge&logo=proto.io&logoColor=white)](https://github.com/KasiMuthuveerappan/Walmart-BlackFridaySale-CaseStudy) | Numpy, Pandas, Seaborn, scipy , boxcox , Ttest , Chisquare , ANOVA , Kruskal-walis , Shapiro-wilk , Mannwhitney_u. | Data analysis, Data Exploration , Data Visualization, Statistics & probability,Hypothesis Testing |This repository provides a detailed exploration of `YULU` Bike rentals data using Hypothsis testing emploting statistical techniques, we delve into the nuances of customer behavior, E-bikes rental patterns offering insights into user behavior & key metrics to enhance understanding and inform strategic decisions.|
